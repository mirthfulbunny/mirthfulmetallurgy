...
public class MoltenHighSpeedSteelFluid {
    ...
    private static ForgeFlowingFluid.Properties makeProperties() {
        return new ForgeFlowingFluid.Properties(
                ModFluidTypes.MOLTEN_HIGH_SPEED_STEEL_TYPE,
                ModFluids.MOLTEN_HIGH_SPEED_STEEL_SOURCE,
                ModFluids.MOLTEN_HIGH_SPEED_STEEL_FLOWING)
                .bucket(ModItems.MOLTEN_HIGH_SPEED_STEEL_BUCKET)
                .block(ModBlocks.MOLTEN_HIGH_SPEED_STEEL_BLOCK);
    }
}
