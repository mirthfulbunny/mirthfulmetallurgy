...
public class HammeringScreen extends AbstractContainerScreen<HammeringMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(MirthfulMetallurgy.MODID, "textures/gui/hammer_table.png");

    public HammeringScreen(HammeringMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
