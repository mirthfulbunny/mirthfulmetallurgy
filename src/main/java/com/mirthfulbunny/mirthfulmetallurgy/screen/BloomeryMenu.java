...
public class BloomeryMenu extends AbstractContainerMenu {
    ...
    public BloomeryMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(3));
    }

    public BloomeryMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.BLOOMERY_MENU.get(), pContainerId);
        checkContainerSize(inv, 3);
        blockEntity = ((BloomeryBlockEntity) entity);
    ...
    public boolean stillValid(@NotNull Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.BLOOMERY.get());
    }
